...
##############################
aws s3 sync "s3://$REPORT_S3_BUCKET_NAME/detox/reports/$DETOX_TEST_TYPE/develop/allure-report/history" "$CI_PROJECT_DIR/e2e-report/allure-report/history" --no-progress --quiet || echo "No history folder in remote found"
