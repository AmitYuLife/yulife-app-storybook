...
const PathwaysReflectionItem = ({ label, onPress, yucoinAmount, status }: IPathwaysReflectionItemProps) => {
  return (
    <PathwaysReflectionCard onPress={onPress} status={status}>
      ...
      <PathwaysReflectionReward left={8} bottom={8} position="absolute" yucoinAmount={yucoinAmount} />
