...
export default function Yuscreen({ isActive, hasNotification, onPressIn, onPressOut, isSuspended }: IIconProps) {
  ...
  return (
    <View>
      ...
      <Text style={[styles.text, { color: fill }]}>{t("navbar.yu.label")}</Text>
    </View>
  );
}
