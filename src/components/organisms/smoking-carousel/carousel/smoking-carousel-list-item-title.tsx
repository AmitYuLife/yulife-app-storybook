...
import { SMOKING_CAROUSEL_LIST_ITEM_CTA } from "@ids";
...
export const SmokingCarouselListItemTitle = memo(({ titleColour, style, id, title }: Props) => {
  ...
  return (
    <View onLayout={handleLayout} style={style} testID={SMOKING_CAROUSEL_LIST_ITEM_CTA(id)}>
      <TextTemplate
