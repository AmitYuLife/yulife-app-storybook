...
const Intro = (props: Partial<DuelStepProps>) => {
  const yucoin = props?.yucoin > 0 ? `${props?.yucoin} ${t("yu_coin.camel_case")}` : t("modals.duels.duel_response_intro.bragging_rights");
  ...
  return (
    <GenericDuelsIntro
      ...
      secondaryBtnLabel={t("labels.cta.decline")}
    />
  );
};
