...
class SplashScreen extends React.PureComponent<IProps> {
  ...
  public render() {
    return (
      <SafeAreaView style={styles.wrapper}>
        <Animatable.View delay={2000} ref={this.setFullLogRef} style={styles.logoWrapper} useNativeDriver={true}>
          <Animatable.View
  ...
  private setFullLogRef = (ref: any) => {
    this.fullLogoRef = ref;
  };

  private handleLogoEaseIn = async () => {
    this.props.onAnimationEnd();

    if (this.fullLogoRef && (this.fullLogoRef as any).splash_yulifeZoomOut) {
      (this.fullLogoRef as any).splash_yulifeZoomOut(500);
    }
  };
}
