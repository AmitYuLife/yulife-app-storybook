...
const getIcon = (status: IProps["status"]) => {
  switch (status) {
    ...
    case "create":
      return (
        <G>
          <Line fill="none" stroke="white" strokeWidth="5" strokeMiterlimit="10" x1="41" y1="55" x2="69" y2="55" />
          <Line fill="none" stroke="white" strokeWidth="5" strokeMiterlimit="10" x1="55" y1="69" x2="55" y2="41" />
        </G>
      );
    default:
      return null;
