        ...
        <ScrollView showsVerticalScrollIndicator={false} style={styles.wrapper}>
            <View style={styles.yumatterWrapper}>
                ...
                <Text style={styles.content}>
                    YuMatter is a confidential employee assistance program designed to support your mental, financial,
                    and professional wellbeing. We are delighted to offer YuMatter through our partnership with
                    Workplace Options.
                </Text>
                ...
                <Text style={styles.content}>
                    Money advisers available to support people facing financial challenges.
                </Text>
                ...
                <View style={styles.loginDetailsWrapper}>
                    ...
                    <TouchableOpacity
                        onPress={() => Linking.openURL(`tel:${yuMatterData.contactNumber.split(" ").join("")}`)}
                    >
