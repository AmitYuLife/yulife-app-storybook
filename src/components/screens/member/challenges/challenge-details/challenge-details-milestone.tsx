...
const ChallengeDetailsMilestoneComponent: React.FC<IChallengeDetailsMilestoneProps> = ({
  milestone,
  surgeMultiplier,
  stars,
  bonusAmount,
...
export const ChallengeDetailsMilestone = memo(ChallengeDetailsMilestoneComponent);
