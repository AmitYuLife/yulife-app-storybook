...
import { Corals, Moutain, OrangeCircle, Pyramid, RedCircle, Trees } from "../svg";
import { initializeAnimation } from "../world-animations";
import assets from "./assets";
import worldData from "./world-4-unity.data";
import styles from "./world-4-unity.styles";
    ...
    return (
      <TouchableWithoutFeedback style={styles.wrapper} onPress={onSkip}>
        <SafeAreaView style={StyleSheet.absoluteFill}>
          <Animatable.View style={styles.wrapper} duration={12000} animation="wrapperAnimation" useNativeDriver={true}>
            <Animatable.View
            ...
            <Animatable.View style={styles.bubble} useNativeDriver={true} animation="pulseAnimation" duration={12000}>
              <Pulse
                size={CIRCLE_SIZE + 6}
                pulseMaxSize={66}
                interval={1250}
