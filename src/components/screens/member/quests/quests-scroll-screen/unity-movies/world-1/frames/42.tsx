...
<Circle fillOpacity="0.1" fill="#E20177" cx="375" cy="562.4" r="60"/>
<G>
<Circle fill="#E20177" cx="375" cy="477" r="8.5"/>
<Line fill="none" stroke="#E20177" strokeWidth="3" x1="375" y1="485.5" x2="375" y2="519.7"/>
</G>
<G>
<Circle fill="#FE870D" cx="351.9" cy="302.8" r="59.7"/>
<Circle fill="#FF9D11" cx="404.7" cy="309" r="30.3"/>
<Polygon fill="#FF5D0F" points="404.7,312.1 399.3,357.8 410.1,357.8 "/>
<Polygon fill="#FD2F0F" points="351.9,308.9 341.3,387.9 362.6,387.9 "/>
<Circle fill="#FFA112" cx="422.7" cy="356.2" r="30.3"/>
<Polygon fill="#FF6F15" points="422.7,359.3 419,394.7 426.5,394.7 "/>
<Circle fill="#FFB40F" cx="407.3" cy="392.5" r="21.4"/>
<Polygon fill="#FF891D" points="407.3,394.7 403.5,427 411.1,427 "/>
<Circle fill="#FFDA0F" cx="375.6" cy="356.5" r="40.4"/>
<Polygon fill="#FF891D" points="375.6,360.6 368.4,421.6 382.7,421.6 "/>
<Circle fill="#EFC306" cx="329.1" cy="376.5" r="30.3"/>
<Polygon fill="#FF891D" points="329.1,379.6 323.8,434.1 334.5,434.1 "/>
</G>
        </G>
    </Svg>
);
