...
class YuCoin extends PureComponent<IProps, IState> {
                        ...
                        >
                            ...
                            >
                                <Polygon
                                    fill="#FFF"
                                    points={
                                        "0.5,277.7 277.9,0.3 403.6,0.3 126.2,277.7"
                                    }
                                />
                                <Polygon
                                    fill="#FFF"
                                    points="141.6,277.7 419,0.3 471.5,0.3 194.1,277.7"
                                />
                            </G>
                        </Svg>
                    </View>
