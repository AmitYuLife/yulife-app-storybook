...
import { LEADERBOARD_NAME, LIST_YUMOJI, SCORE } from "@ids";
...
const _ListRankItem = ({
  ...
  id = "",
  index,
  componentId = ROUTES.leaderboard,
  ...
  return (
    <>
      <TouchableOpacityWithDelay
        testID={LEADERBOARD_NAME(name, score.toString(), rank, "leaderboard")}
        delay={200}
      ...
      >
        <Animated.View style={baseStyles.wrapper}>
          ...
          <View style={baseStyles.borderWrapper} testID={RANK(name, rank)}>
            ...
            <Score score={score} bold={isCurrentUser} testID={SCORE(score)} />
          </View>
        </Animated.View>
      </TouchableOpacityWithDelay>
    </>
