...
import { gql, QuestMapLevelChallengeDetailsContent } from "@graphql/__generated";
...
const FiitMediaListContainer = ({ contentMediaTags, level, levelSlotTemplateId, yuniversalMap }: IProps) => {
  ...
  const title = internalContent?.mediaListHeader || internalContent?.title;
  ...
  const handleOnItemPress = useCallback(
    ...
    [dispatch, level, levelSlotTemplateId, title]
  );
  ...
  return (
    <FiitMediaListScreen
      ...
      providerLogo={internalContent?.providerLogo}
