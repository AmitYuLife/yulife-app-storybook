...
export const FINAL_PROGRESS = 2500;
...
export enum ACCUMULATED_PROGRESS {
  ...
  FIB_GENDER_SCREEN_ID = 1300,
  FIB_MEDICAL_HISTORY_SCREEN_ID = 1400,
  FIB_MEDICAL_THREE_OR_MORE_CONSULTATION_SCREEN_ID = 1500,
  FIB_THREE_YEAR_MEDICAL_HISTORY_SCREEN_ID = 1520,
  FIB_HIGH_BLOOD_PRESSURE_SCREEN_ID = 1520,
  FIB_HIGH_BLOOD_PRESSURE_EXTRA_SCREEN = 1525,
  FIB_HIGH_CHOLESTEROL_SCREEN_ID = 1530,
  FIB_HIGH_CHOLESTEROL_EXTRA_SCREEN = 1535,
  FIB_DIGESTIVE_SCREEN_ID = 1540,
  FIB_MEDICAL_JOURNEY_EARS_NOSE_THROAT_SCREEN_ID = 1550,
  FIB_MEDICAL_JOURNEY_EYE_SCREEN_ID = 1560,
  FIB_MEDICAL_JOURNEY_KIDNEYS_BLADDER_SCREEN_ID = 1570,
  FIB_MEDICAL_JOURNEY_LUNGS_SCREEN_ID = 1580,
  FIB_MEDICAL_JOURNEY_MINOR_INJURIES_SCREEN_ID = 1590,
  FIB_MEDICAL_JOURNEY_MUSCLES_JOINTS_SCREEN_ID = 1600,
  FIB_MEDICAL_JOURNEY_SKIN_SCREEN_ID = 1620,
  FIB_MEDICAL_JOURNEY_OTHER_SCREEN_ID = 1630,
  FIB_HOSPITAL_STAY_SCREEN_ID = 1640,
  FIB_SYMPTOMS_RESOLVED_SCREEN_ID = 1650,
  FIB_CONDITION_STABLE_SCREEN_ID = 1660,
  FIB_DAILY_ACTIVITIES_RESTRICTIONS_SCREEN_ID = 1670,
  FIB_MEDICAL_OUTSTANDING_MEDICAL_INVESTIGATIONS_SCREEN_ID = 1800,
  FIB_MEDICAL_OTHER_SYMPTOMS_SCREEN_ID = 1900,
  FIB_MEDICAL_COVID_ISOLATION_SCREEN_ID = 2000,
  FIB_MEDICAL_COVID_SYMPTOMS_SCREEN_ID = 2100,
  FIB_FINANCIAL_QUESTIONS_SCREEN_ID = 2200,
...
export const data: UnderwritingJourneyScreen[] = [
  ...
  },
  {
    ...
    icon: GENDER_ICON,
    accumulatedProgress: ACCUMULATED_PROGRESS.FIB_GENDER_SCREEN_ID,
    children: [
      {
        type: "markdown",
  ...
  },
  {
    ...
    previousButton: { actionId: FIB_GENDER_SCREEN_ID },
