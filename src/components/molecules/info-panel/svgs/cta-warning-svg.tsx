...
const CtaWarningSVG = ({ size = Style.adjust(16), color = "white", ...props }: IProps) => {
  return (
    <Svg width={size} height={size} viewBox="0 0 16 16" fill="none" testID={INFO_PANEL_CTA_WARNING_BUTTON} {...props}>
      <Path
        fillRule="evenodd"
        clipRule="evenodd"
...
export default memo(CtaWarningSVG);
