...
const Plus = ({ scale = 1, colour }: IProps) => (
  <Svg width={String(19 * scale)} height={String(19 * scale)} viewBox="0 0 19 19">
    <Path fill={colour || Colours.darkHotPink} stroke={colour || Colours.darkHotPink} d={path} />
  </Svg>
);
