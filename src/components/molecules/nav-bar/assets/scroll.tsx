...
const Scroll: SFC<IconProps> = ({ colour = COLOURS.LIGHT, hasDismiss, isActive, isIconHidden, isPressed }) => {
        ...
        <G>
            {isIconHidden ? null : (
                <>
                    ...
                    />
                    <Rect x="208.5" y="76.3" fill={fill} width="30" height="3" />
                    <Rect x="208.5" y="82.3" fill={fill} width="30" height="3" />
                    <Rect x="208.5" y="88.3" fill={fill} width="22" height="3" />
                </>
            )}
            {!hasDismiss ? (
                <Circle fill={fill} cx="223.5" cy="18" r="10" />
            ) : (
                <G x={41} y={-32}>
                    <Path
                        scale={0.8}
