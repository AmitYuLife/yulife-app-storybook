...
export const getWrapperStyle = (type: string) => {
    switch (type) {
        ...
        case BUTTON_TYPES.PRIMARY_MEDIUM:
            return StyleSheet.flatten([styles.wrapperPrimary, styles.wrapperPrimaryMedium]);
        case BUTTON_TYPES.PRIMARY_SMALL:
            return StyleSheet.flatten([styles.wrapperPrimary, styles.wrapperPrimarySmall]);
...
export const getShadowStyle = (type: string) => {
    switch (type) {
        ...
        case BUTTON_TYPES.PRIMARY_MEDIUM:
            return StyleSheet.flatten([styles.shadow, styles.shadowMedium]);
        case BUTTON_TYPES.PRIMARY_SMALL:
            return StyleSheet.flatten([styles.shadow, styles.shadowSmall]);
        case BUTTON_TYPES.PRIMARY_GREYSCALE_SMALL:
