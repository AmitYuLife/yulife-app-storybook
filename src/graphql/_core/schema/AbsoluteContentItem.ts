...
export interface AbsoluteContentItem_item_ContentItemWrapper_localDispatchActions {
  type: SduiActionType;
  payload: string | null;
}

export interface AbsoluteContentItem_item_ContentItemWrapper_localDispatchActionsOnMount {
  type: SduiActionType;
  payload: string | null;
}
...
export interface AbsoluteContentItem_item_ContentItemWrapper {
   ...
   * Supported RN Version 3.101.0
   */
  localDispatchActions: AbsoluteContentItem_item_ContentItemWrapper_localDispatchActions[] | null;
  /**
   * Supported RN Version 3.101.0
   */
  localDispatchActionsOnMount: AbsoluteContentItem_item_ContentItemWrapper_localDispatchActionsOnMount[] | null;
}
...
export interface AbsoluteContentItem_item_ContentItemBoxOptionCard_event {
  type: SduiActionType;
  payload: string | null;
}
...
export interface AbsoluteContentItem_item_ContentItemBoxOptionCard {
  ...
  event: AbsoluteContentItem_item_ContentItemBoxOptionCard_event | null;
...
export interface AbsoluteContentItem_item_ContentItemSliderInput_styles {
  property: string;
  value: string;
}

export interface AbsoluteContentItem_item_ContentItemSliderInput {
