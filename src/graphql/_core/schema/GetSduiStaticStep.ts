...
export interface GetSduiStaticStep_getSduiStaticStep_body_ContentItemWrapper_localDispatchActions {
  type: SduiActionType;
  payload: string | null;
}

export interface GetSduiStaticStep_getSduiStaticStep_body_ContentItemWrapper_localDispatchActionsOnMount {
  type: SduiActionType;
  payload: string | null;
}
...
export interface GetSduiStaticStep_getSduiStaticStep_body_ContentItemBoxOptionCard_event {
  type: SduiActionType;
  payload: string | null;
}
...
export interface GetSduiStaticStep_getSduiStaticStep_body_ContentItemBoxOptionCard {
  ...
  event: GetSduiStaticStep_getSduiStaticStep_body_ContentItemBoxOptionCard_event | null;
...
export interface GetSduiStaticStep_getSduiStaticStep_body_ContentItemSliderInput_styles {
  property: string;
  value: string;
}

export interface GetSduiStaticStep_getSduiStaticStep_body_ContentItemSliderInput {
  ...
  leftLabel: string;
  rightLabel: string;
  styles: GetSduiStaticStep_getSduiStaticStep_body_ContentItemSliderInput_styles[] | null;
}

export interface GetSduiStaticStep_getSduiStaticStep_body_ContentItemTextAreaInput_styles {
  property: string;
  value: string;
}

export interface GetSduiStaticStep_getSduiStaticStep_body_ContentItemTextAreaInput {
  ...
  numberOfLines: number | null;
  maxLength: number;
  styles: GetSduiStaticStep_getSduiStaticStep_body_ContentItemTextAreaInput_styles[] | null;
}
...
export type GetSduiStaticStep_getSduiStaticStep_body =
  ...
  | GetSduiStaticStep_getSduiStaticStep_body_ContentItemSliderInput
  | GetSduiStaticStep_getSduiStaticStep_body_ContentItemTextAreaInput;
...
export interface GetSduiStaticStep_getSduiStaticStep_absolute_item_ContentItemWrapper_localDispatchActions {
  type: SduiActionType;
  payload: string | null;
}

export interface GetSduiStaticStep_getSduiStaticStep_absolute_item_ContentItemWrapper_localDispatchActionsOnMount {
  type: SduiActionType;
  payload: string | null;
}
...
export interface GetSduiStaticStep_getSduiStaticStep_absolute_item_ContentItemBoxOptionCard_event {
  type: SduiActionType;
  payload: string | null;
}
...
export interface GetSduiStaticStep_getSduiStaticStep_absolute_item_ContentItemBoxOptionCard {
  ...
  event: GetSduiStaticStep_getSduiStaticStep_absolute_item_ContentItemBoxOptionCard_event | null;
   ...
   */
  titleWrapperStyles:
    | GetSduiStaticStep_getSduiStaticStep_absolute_item_ContentItemBoxOptionCard_titleWrapperStyles[]
    | null;
  /**
   * Supported RN version 3.96.0
   */
...
export interface GetSduiStaticStep_getSduiStaticStep_absolute_item_ContentItemSliderInput_styles {
  property: string;
  value: string;
}

export interface GetSduiStaticStep_getSduiStaticStep_absolute_item_ContentItemSliderInput {
  __typename: "ContentItemSliderInput";
  id: string;
  answerKey: string;
  minValue: number;
  ...
  leftLabel: string;
  rightLabel: string;
  styles: GetSduiStaticStep_getSduiStaticStep_absolute_item_ContentItemSliderInput_styles[] | null;
}

export interface GetSduiStaticStep_getSduiStaticStep_absolute_item_ContentItemTextAreaInput_styles {
  property: string;
  value: string;
}

export interface GetSduiStaticStep_getSduiStaticStep_absolute_item_ContentItemTextAreaInput {
  __typename: "ContentItemTextAreaInput";
  id: string;
  answerKey: string;
  placeholder: string | null;
  numberOfLines: number | null;
  maxLength: number;
  styles: GetSduiStaticStep_getSduiStaticStep_absolute_item_ContentItemTextAreaInput_styles[] | null;
}
...
export type GetSduiStaticStep_getSduiStaticStep_absolute_item =
  ...
  | GetSduiStaticStep_getSduiStaticStep_absolute_item_ContentItemSliderInput
  | GetSduiStaticStep_getSduiStaticStep_absolute_item_ContentItemTextAreaInput;
