...
import {
  ...
  GQL_FRAGMENT_CONTENT_ITEM_PERSONAL_PRODUCT_PREVIEW,
  ...
  GQL_FRAGMENT_CONTENT_ITEM_YUGI_CONFIRM,
  GQL_FRAGMENT_CONTENT_ITEM_PERSONAL_PRODUCT_INFO,
  GQL_FRAGMENT_CONTENT_ITEM_GP_DETAILS,
  GQL_FRAGMENT_CONTENT_ITEM_MULTI_BUTTON,
  GQL_FRAGMENT_CONTENT_ITEM_AGE_PERCENT_COVER_PICKER,
  ...
  query GetPersonalProductStep($productId: String!) {
    getPersonalProductStep(productId: $productId) {
      ...
      body {
        ...
        ... on ContentItemAgePercentCoverPicker {
      ...
      absolute {
        ...
        item {
          ...
          ... on ContentItemCollapsingHeaderAgePercentProductInfo {
