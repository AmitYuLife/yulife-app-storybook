...
export default {
    ...
    streak: {
        ...
        subheadingTodayStreakDone: "Come back tomorrow to carry on.",
        subheadingInstrucion: "Do ${streakMax} challenges in a row to earn ${reward}.",
        headingCompleted: "Streak completed",
        headingCompletedTodayStreak: "Completed streak day ${streakCompleted}",
        headingStartStreakDay: "Start streak day ${streakCompleted}"
    },
    pushNotification: {
        toSettings: {
