...
export const GOALS_FTUE = {
    ...
    "info": [
        ...
        "description": {
            "en-GB": "We’re activley developing this feature and would love to hear your feedback! You can contact us via the “Chat” button located in side menu on the main screen. ",
            "ja-JP": "私たちはこの機能を積極的に開発しており、お客様のご意見をお聞きしたいと思います！メイン画面のサイドメニューにある「チャット」ボタンからご連絡ください。",
        },
        "imageKey": "cms/1651069814232_Group 1483.png",
        }
    ],
