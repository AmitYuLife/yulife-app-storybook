...
export const USER_SOCIAL_LEADERBOARD_ENROLLMENT_5_U1_STEPS = {
  type: "mongo",
  modelName: "user_social_leaderboard_enrolments",
  data: {
    _id: generateRandomMongoId(),
...
export const USER_SOCIAL_LEADERBOARD_ENROLLMENT_19_U1_STEPS = {
  type: "mongo",
  modelName: "user_social_leaderboard_enrolments",
  data: {
    _id: generateRandomMongoId(),
...
export const USER_SOCIAL_LEADERBOARD_ENROLLMENT_20_U1_STEPS = {
  type: "mongo",
  modelName: "user_social_leaderboard_enrolments",
  data: {
    _id: generateRandomMongoId(),
...
export const USER_SOCIAL_LEADERBOARD_UNION_ENROLLMENT_39_STEPS = {
  type: "mongo",
  modelName: "user_social_leaderboard_enrolments",
  data: {
    _id: generateRandomMongoId(),
...
export const USER_SOCIAL_LEADERBOARD_ENROLLMENT_40_U1_STEPS = {
  type: "mongo",
  modelName: "user_social_leaderboard_enrolments",
  data: {
    _id: generateRandomMongoId(),
