// commenting out as test has since been copied to it's own folder
// being deleted in other branch, until then need to investigate why the data from surveys is also pooling into activity
