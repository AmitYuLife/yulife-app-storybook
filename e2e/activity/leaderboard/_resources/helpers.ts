...
export const CREATE_AVATAR = (customer: any) => async () => {
  ...
  When("I tap a hair colour", when.tapColour("#653F31"), async () => {
  ...
  When("I tap a colour", when.tapColour("#2B2B2B"), async () => {
    When("I tap on the Headwear tab", when.tapTab("headwear", true, "left", "eyes"), async () => {
  ...
  When("I tap the eyes tab", when.tapTab("eyes", true, "right", "facialHair"), async () => {
  ...
  When("I select a colour", when.tapColour("#3C9172"), async () => {
    When(
      "I tap the accessories tab",
      when.tapTab("glasses", true, "left", "facialHair"),
      async () => {
