...
export const followEmailLink =
  (emailAddress: string, options?: FollowEmailLinkOptions) => async () => {
    ...
    // Clears stored credentials before opening the deeplink
    if (options?.clearKeychainBeforeLaunch) {
