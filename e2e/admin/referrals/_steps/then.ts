...
export const { wait, idVisible, textVisible, idNotVisible, textNotVisible, multipleTextVisible } = navigation.common;
...
export const referralsPopoverVisible =
    ...
    async () => {
        ...
        const popoverText = element(by.text(`Share the love and get ${referralReward} YuCoin for every referral.`));
