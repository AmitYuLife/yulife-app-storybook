...
export const criticalIllnessProductItem: YuScreenProductCard = {
  ...
  mainImage:
    "https://yulife-develop.imgix.net/yuscreen/product-card-carousel/illustrations/aviva/aviva-gci-square.png?ixlib=js-3.2.1&fit=clip&fm=png&dpr=1&s=a0d41245ba9f55976a4bd0b9573c0962",
};
...
export const FACIAL_HAIR_ITEMS = [
  "",
  "totes_ma_goat",
  "puffy_full_beard",
  "fat_lumberjack",
  ...
  "amateur_magician",
  "hipster",
  "moustache_with_beard",
  "subtle_wolvering",
  "stuble_wolverine",
  "konchita_wurst",
  "happy_konchita_wurst",
  "full_beard_mouth",
  "stubble_full_beard_mouth",
  "trending_goatey",
  "stubble_trending_goatey",
  "the_pinstripe",
  "messy_chin",
  "goatey_with_stubble",
  "the_badass",
