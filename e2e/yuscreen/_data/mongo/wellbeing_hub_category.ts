...
import { BUSINESS_ACCOUNT_10_GHI_REWARDS, BUSINESS_ACCOUNT_4, BUSINESS_ACCOUNT_6 } from "../postgres/business";
import {
    WELLBEING_HUB_ITEM_1,
    WELLBEING_HUB_ITEM_2,
...
export const WELLBEING_HUB_CATEGORY_2 = {
    modelName: "wellbeing_hub_category",
    type: "mongo",
    data: {
        _id: generateRandomMongoId(),
