...
Feature("I can view and use the smoking cessation feature", async () => {
  ...
  // commenting out all the below as are currently broken due to table changes - being worked on by Rogers
  ...
  //     Then(
  //       "I should be on the smoking hub (and can see the milestones from a previous streak are still there despite this streak being less",
  //       then.onSmokingHub(locale, 18, true, SMOKING_STATE_LEELA.data.meta_data.weeklyExpense, SMOKING_STATE_LEELA.data.meta_data.amountUsedPerDay, LEELA_SMOKING_TIPS, LEELA_MOMENTS_AND_REASONS, 25)
  //     );
  //   });
