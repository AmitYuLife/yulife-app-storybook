...
import { GOAL_PRODUCTS_1, GOAL_PRODUCTS_2, GOAL_PRODUCTS_3 } from "../mongo/goal_products";
...
export const BUSINESS_PRODUCT_17_GHI_NO_START_DATE = generateProductRecords({
    productCode: ProductCode.groupHealth,
    carrier: Carrier.Bupa,
    productId: "YUG1010115",
    policyName: "No stat date policy",
    businessAccountId: BUSINESS_ACCOUNT_GHI_8.data.business_account_id,
    product: {
        policy_start_date: moment().add(1, "y").format(format),
    },
    quote: {
        business_quote_id: "N05T4RT",
        external_quote_id: "1234",
        archived: false,
        unit_rate: null,
        provisional_automatic_acceptance_limit: null,
