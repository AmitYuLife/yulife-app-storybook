...
Feature("PLI SAD", async () => {
  ...
  Scenario(
    "As a user whose latest quote is 61 days old and whose application got rejected, then getting into the journey should show me that I am still rejected.",
    scenario.start,
    async () => {
      Given(
  ...
  Scenario(
    ...
    async () => {
      Given(
        "I login as a user with Covea FIB enabled",
        given.loginToYuScreen(false, CUSTOMER_PLI_6, AUTH_PLI_6),
        async () => {
