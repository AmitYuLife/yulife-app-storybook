...
export const onHQInformationScreen = (copy: any) => async () => {
  ...
  await scrollUntilTextVisible(ids.SDUI_BODY_SCROLL, copy.boxOneTitle, "down")();
  await scrollUntilTextVisible(ids.SDUI_BODY_SCROLL, copy.boxOneDescription, "down")();
  await scrollUntilTextVisible(ids.SDUI_BODY_SCROLL, copy.boxTwoTitle, "down")();
  await scrollUntilTextVisible(ids.SDUI_BODY_SCROLL, copy.boxTwoDescription, "down")();
  await scrollUntilTextVisible(ids.SDUI_BODY_SCROLL, copy.boxThreeTitle, "down")();
  await scrollUntilTextVisible(ids.SDUI_BODY_SCROLL, copy.boxThreeDescription, "down")();
  await scrollUntilTextVisible(ids.SDUI_BODY_SCROLL, copy.infoBox, "down")();
  await scrollFromID(ids.SDUI_BODY_SCROLL, "up", "fast")();
