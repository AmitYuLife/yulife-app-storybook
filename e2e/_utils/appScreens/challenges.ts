import { navigateViaText, navigateViaID, CHALLENGE_TILE, idVisible, CHALLENGE_PROGRESS_BAR, wait, LEVEL_CHALLENGE_BUTTON, expectIsVisibleViaID, textVisible, CALM_BUTTON, HEADSPACE_BUTTON, MEDITATION_STAR_REWARD, MEDITATION_YUCOIN_REWARD, 
    ...
    VIDEO_PLAYER, VIDEO_LOGO, MEDITATION_PARTNER_LOGO } from "@navigation"
...
export const tapAwarenessContentCard = (mins1: string, yuCoin1: string) => async () => {
    await navigateViaText(`${mins1} min • Earn ${yuCoin1}`)
}
