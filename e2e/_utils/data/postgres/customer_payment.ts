...
import { CUSTOMER_POLICY_DENTAL_1, CUSTOMER_POLICY_DENTAL_2, CUSTOMER_POLICY_DENTAL_3, CUSTOMER_POLICY_DENTAL_85, CUSTOMER_POLICY_DENTAL_RENEW, CUSTOMER_POLICY_DENTAL_RENEW_2, CUSTOMER_POLICY_PLI_6 } from "./customer_policy";
import { PAYMENT_PLAN_DENTAL_1, PAYMENT_PLAN_DENTAL_2, PAYMENT_PLAN_DENTAL_3, PAYMENT_PLAN_DENTAL_85, PAYMENT_PLAN_DENTAL_RENEW, PAYMENT_PLAN_DENTAL_RENEW_2, PAYMENT_PLAN_PLI_6 } from "./payment_plan";
...
export const CUSTOMER_PAYMENT_6 = {
    type: "postgres",
    modelName,
    data: {
        policyId: CUSTOMER_POLICY_PLI_6.data.policyId,
