import { CUSTOMER_DENTAL_1, CUSTOMER_DENTAL_2, CUSTOMER_45, CUSTOMER_PLI_6, CUSTOMER_85, CUSTOMER_DENTAL_RENEW, CUSTOMER_DENTAL_RENEW_2 } from "./customers";
...
export const PAYMENT_PLAN_PLI_6 = {
    type: "postgres",
    modelName,
    data: {
        planId: generateRandomPostgresId(),
        providerSubscriptionId: `sub_${CUSTOMER_PLI_6.data.customerId}`,
        raiseInvoiceDayOfMonth: 1,
        paymentCaptureDaysAfterInvoice: 0
    }
};
