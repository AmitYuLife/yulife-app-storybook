...
import { CUSTOMER_2, CUSTOMER_3, CUSTOMER_4, CUSTOMER_6, CUSTOMER_7, CUSTOMER_8, CUSTOMER_9, CUSTOMER_12, CUSTOMER_13, CUSTOMER_14, CUSTOMER_15, CUSTOMER_18, CUSTOMER_17, CUSTOMER_22, CUSTOMER_23, CUSTOMER_24, CUSTOMER_19, CUSTOMER_16, CUSTOMER_35, CUSTOMER_36, CUSTOMER_37, CUSTOMER_38, CUSTOMER_39, CUSTOMER_40, CUSTOMER_41, CUSTOMER_42, CUSTOMER_44, CUSTOMER_47, CUSTOMER_50, CUSTOMER_MEDITOPIA_2, CUSTOMER_MEDITOPIA_3, CUSTOMER_52, CUSTOMER_54, CUSTOMER_55, CUSTOMER_56, CUSTOMER_57, CUSTOMER_58, CUSTOMER_60, CUSTOMER_61, CUSTOMER_63, CUSTOMER_64, CUSTOMER_66, CUSTOMER_65, CUSTOMER_67, CUSTOMER_68, CUSTOMER_71, CUSTOMER_69, CUSTOMER_70, CUSTOMER_72, CUSTOMER_73, CUSTOMER_75, CUSTOMER_76, CUSTOMER_77, CUSTOMER_78, CUSTOMER_79, CUSTOMER_80, CUSTOMER_81, CUSTOMER_82, CUSTOMER_83, CUSTOMER_20, CUSTOMER_FIIT } from '../postgres/customers';
import {
...
export const COIN_LEDGER_20 = {
    ...
    data:{
        _id: generateRandomMongoId(),
        customerId: CUSTOMER_20.data.customerId,
...
export const COIN_LEDGER_35 = {
    ...
    export const COIN_LEDGER_67 = {
        ...
        data: {
            _id: generateRandomMongoId(),
            customerId: CUSTOMER_67.data.customerId,
    ...
    export const COIN_LEDGER_68 = {
        ...
        data: {
            _id: generateRandomMongoId(),
            customerId: CUSTOMER_68.data.customerId,
    ...
    export const COIN_LEDGER_69 = {
        ...
        data: {
            _id: generateRandomMongoId(),
            customerId: CUSTOMER_69.data.customerId,
    ...
    export const COIN_LEDGER_70 = {
        ...
        data: {
            _id: generateRandomMongoId(),
            customerId: CUSTOMER_70.data.customerId,
    ...
    export const COIN_LEDGER_71 = {
        ...
        data:{
            _id: generateRandomMongoId(),
            customerId: CUSTOMER_71.data.customerId,
    ...
    export const COIN_LEDGER_72 = {
        ...
        data:{
            _id: generateRandomMongoId(),
            customerId: CUSTOMER_72.data.customerId,
...
export const COIN_LEDGER_78 = {
    ...
    data: {
        _id: generateRandomMongoId(),
        customerId: CUSTOMER_78.data.customerId,
...
export const COIN_LEDGER_79 = {
    ...
    data: {
        _id: generateRandomMongoId(),
        customerId: CUSTOMER_79.data.customerId,
...
export const COIN_LEDGER_80 = {
    ...
    data: {
        _id: generateRandomMongoId(),
        customerId: CUSTOMER_80.data.customerId,
...
export const COIN_LEDGER_81 = {
    ...
    data: {
        _id: generateRandomMongoId(),
        customerId: CUSTOMER_81.data.customerId,
...
export const COIN_LEDGER_83 = {
    ...
    data: {
        _id: generateRandomMongoId(),
        customerId: CUSTOMER_83.data.customerId,
...
export const COIN_LEDGER_FIIT = {
  ...
  data: {
    _id: generateRandomMongoId(),
    customerId: CUSTOMER_FIIT.data.customerId,
