...
export const CORE_REWARDS_URBAN_GHI_REWARDS = {
    ...
    "restrictions": {
      "availableForLabels": [
        "649bd68bf4e68234f8dd9f3b_tease",
        "649bd68bf4e68234f8dd9f3b_claimable"
      ],
      "restrictedForLabels": [],
      "locations": [
        "GB"
    ...
    "code": "urban",
    "description": {
      "en-GB": "If you’ve ever wanted all your massage, beauty, osteopathy, physiotherapy, and pregnancy wellness needs to be met in a day, Urban massage can deliver! (Bet that’ll be a really relaxing day.) \n\nUrban Massage works with qualified mobile therapists of these respective disciplines, to deliver safe home treatment. If you ever have a bad day, Urban Massage Therapist to the rescue.",
      "ja-JP": "マッサージ、ビューティー、オステオパシー、フィジオセラピー、妊娠中のウェルネス・ニーズを1日ですべて満たしたいと思ったことがあるなら、アーバン・マッサージにお任せを！(きっとリラックスした一日になるはずだ。）\n\nアーバン・マッサージは、それぞれの分野の資格を持ったモバイル・セラピストと協力し、安全な自宅でのトリートメントをお届けします。嫌なことがあったら、アーバン・マッサージ・セラピストにお任せください。"
    },
    "currencyCode": "GBP",
...
export const CORE_REWARDS_BOOTS_GHI_REWARDS = {
    ...
    "restrictions": {
      "availableForLabels": [
        "64c8f5a1d4e9db6e99f5248f_tease",
        "64c8f5a1d4e9db6e99f5248f_claimable"
      ],
      "restrictedForLabels": [],
      "locations": [
        "GB"
    ...
    "redemptionSteps": {
      "steps": [
        ...
        },
        {
          ...
          "ja-JP": "チェックアウトの際、\"offer code \"と表示されているところにクーポンコードを入力してください。"
        },
        {
...
export const CORE_REWARDS_YORK_GHI_REWARDS = {
    ...
    "restrictions": {
      "availableForLabels": [
        "64c38f7ecb39c9d50a3c14ef_tease",
        "64c38f7ecb39c9d50a3c14ef_claimable"
      ],
      "restrictedForLabels": [],
      "locations": [
        "GB"
...
export const CORE_REWARDS_BUPA_GHI_REWARDS = {
    ...
    "restrictions": {
      "availableForLabels": [
        "64a403a408975d03a0aa63ff_tease",
        "64a403a408975d03a0aa63ff_claimable"
      ],
      "restrictedForLabels": [],
      "locations": [
        "GB"
    ...
    "redemptionSteps": {
      "steps": [
        ...
        },
        {
          ...
          "es-ES": "Llame al número de las Clínicas Bupa en XXX XXX XXXX para reservar su evaluación de salud en persona.",
          "ja-JP": "Bupa Clinicsの電話番号0370 218 4965に電話して、対面式健康診断を予約してください。"
        },
        {
          "en-GB": "Mention that you are a YuLife member, and make sure you give the consultant your unique voucher number (in your email) to get your health assessment for free. Your membership details can be found in your Bupa Touch account.",
          "es-ES": "Mencione que es miembro de YuLife y asegúrese de dar al asesor su número de vale único (en su correo electrónico) para obtener una evaluación sanitaria gratuita.",
          "ja-JP": "ゆうらいふの会員であることを伝え、コンサルタントが無料で健康診断を受けられるように、あなた固有のバウチャー番号（Eメールに記載）を必ず伝えてください。会員情報はBupa Touchアカウントでご確認いただけます。"
        },
        {
...
export const CORE_REWARDS_LIVING_DNA_GHI_REWARDS = {
    ...
    data: {
        ...
        "restrictions": {
          "availableForLabels": [
            "64ad4e2d87cea9cd5185cd8f_tease",
            "64ad4e2d87cea9cd5185cd8f_claimable"
          ],
          "restrictedForLabels": [],
          "locations": [
            "GB"
        ...
        "redemptionSteps": {
          "steps": [
            ...
            {
              "en-GB": "Fill in your details to get your Living DNA kit ordered, and your test will be shipped to your desired address.",
            ...
            {
              "en-GB": "Follow the simple instructions in your kit to activate your account and take your sample.",
              "ja-JP": "キットに記載されている簡単な手順に従って、アカウントを有効化し、サンプルを採取してください。"
            },
            {
              "en-GB": "After you’ve posted the sample, your DNA results will be accessible on your Living DNA account within 6 – 8 weeks of arrival at the lab (their scientists are hard at work processing thousands of years of DNA data for you).",
              "ja-JP": "サンプルの郵送後、DNA鑑定結果はラボ到着後6～8週間以内にLiving DNAのアカウントからアクセスできるようになります（ラボの科学者たちは、あなたのために何千年ものDNAデータを懸命に処理しています）。"
            },
            {
...
export const CORE_REWARDS_GARMIN_GHI_REWARDS = {
    ...
    "restrictions": {
      "availableForLabels": [
        "64bf87537b74ab1ef759eece_tease",
        "64bf87537b74ab1ef759eece_claimable"
      ],
      "restrictedForLabels": [],
      "locations": [
        "GB"
  ...
  data: {
    ...
    "restrictions": {
      "availableForLabels": [
        ...
        "64b7b195a85859af773442e4_claimable"
      ],
      "restrictedForLabels": [],
      "locations": [
        "GB"
...
export const CORE_REWARDS_ORDO_REWARDS = {
  ...
  data: {
    ...
    "restrictions": {
      "availableForLabels": [
        "6572cb3f8f7531b2fa7962db_claimable"
      ],
      "restrictedForLabels": [],
      "locations": [
        "GB"
