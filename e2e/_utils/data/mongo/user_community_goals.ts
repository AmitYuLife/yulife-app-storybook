...
import { CUSTOMER_19, CUSTOMER_20, CUSTOMER_47 } from "../postgres/customers"
import { CORE_COMMUNITY_GOAL_1 } from "./core_community_goals"
import { USER_20_LEADERBOARD } from "./leaderboard"
import { USER_19, USER_20, USER_34, USER_43 } from "./users"
...
export const USER_COMMUNITY_GOALS_3 = {
    type,
    modelName,
    data: {
        _id: generateRandomMongoId(),
