   ...
   data: {
      ...
      "content": [
        ...
        },
        {
          ...
          "markdown": {
            "en-GB": "To get a diagnosis, book GP appointments, and view prescription orders — apply using the Blua Health application.",
            "ja-JP": "診断、GPの予約、処方箋の閲覧には、ブルア・ヘルスのアプリケーションをご利用ください。"
          },
          "_id": generateRandomMongoId(),
          "type": "MARKDOWN"
        },
        ...
        },
        {
          ...
          "markdown": {
            ...
            "ja-JP": "Apple App StoreまたはGoogle Playからブルア・ヘルス・アプリをダウンロードしてください。"
          },
          "_id": generateRandomMongoId(),
          "type": "MARKDOWN"
        },
        ...
        },
        {
         ...
         "markdown": {
           ...
           "ja-JP": "アプリからチャットでお問い合わせいただくか、ヘルプセンターで詳細をご覧ください。"
         },
         "_id": null,
         "type": "MARKDOWN",
         "image": "imgix::cms/1690814320046_App Store.jpg",
      ...
      "content": [
        {
          ...
          "markdown": {
            "en-GB": "Speak to a qualified nurse about any health concern with Anytime HealthLine. \n\nSeek support and advice whenever you need without taking time away from work.",
            "ja-JP": "健康上の心配事については、Anytime HealthLineで資格を持った看護師にご相談ください。\n\n仕事を休むことなく、必要なときにいつでもサポートやアドバイスを受けることができます。"
          },
          "_id": generateRandomMongoId(),
          "type": "MARKDOWN"
        },
      ...
      "content": [
        {
          ...
          "markdown": {
            "en-GB": "If you are concerned about a child’s emotional or mental wellbeing, Bupa’s Family Mental HealthLine provides guidance and support to parents, guardians, and carers alike.",
            "ja-JP": "子どもの感情的または精神的な健康が心配な場合、BupaのFamily Mental HealthLineは、両親、保護者、介護者にガイダンスとサポートを提供します。"
          },
          "_id": generateRandomMongoId(),
          "type": "MARKDOWN"
        },
        {
          ...
          "markdown": {
            ...
            "ja-JP": "電話サービスを通じて、訓練を受けたアドバイザーによるメンタルヘルスサポートを受けることができる。"
          },
          "_id": generateRandomMongoId(),
          "type": "MARKDOWN"
        },
        ...
        },
        {
          ...
          "markdown": {
            "en-GB": "Family Mental HealthLine: 0345 266 7938\n\nDo note: Your Bupa Membership Details will be required — find them in your Bupa Touch account.",
            "ja-JP": "ファミリー・メンタルヘルス・ライン：0345-266-7938\n\nご注意：Bupa会員の詳細が必要となります。"
          },
          "_id": generateRandomMongoId(),
          "type": "MARKDOWN"
        },
   ...
   data: {
      ...
      "content": [
        ...
        },
        {
          ...
          "markdown": {
            "en-GB": "Receive clinical advice and support from a menopause-trained nurse via telephone service.",
            "ja-JP": "更年期障害のトレーニングを受けた看護師から、電話サービスを通じて臨床的なアドバイスやサポートを受けることができる。"
          },
          "_id": generateRandomMongoId(),
          "type": "MARKDOWN"
        },
        ...
        },
        {
          ...
          "markdown": {
            "en-GB": "Menopause HealthLine: 0345 608 9984\n\nDo note: Your Bupa Membership Details will be required — find them in your Bupa Touch account.",
            "ja-JP": "メノポーズ・ヘルスライン：0345 608 9984\n\nご注意：Bupa会員の詳細が必要となります。"
          },
          "_id": generateRandomMongoId(),
          "type": "MARKDOWN"
        },
      ...
      "content": [
        {
          ...
          "markdown": {
            "en-GB": "For certain medical conditions, remote assessment with a trained advisor, therapist or clinician, can be made available by contacting Bupa directly. \n\nIf eligible, you could receive fast access consultation or treatment with the right healthcare providers. \n\nEligible conditions:\n\nConcerns about Mental Health \nMusculoskeletal concerns\nSymptoms of Cancer",
            "ja-JP": "特定の病状については、訓練を受けたアドバイザー、セラピストまたは臨床医による遠隔アセスメントを、Bupaに直接連絡することで利用できる。\n\n資格があれば、適切な医療提供者による診察や治療を迅速に受けることができる。\n\n対象となる病状\n\nメンタルヘルスに関するお悩み\n筋骨格系に関する懸念\nがんの症状"
          },
          "_id": generateRandomMongoId(),
          "type": "MARKDOWN"
        },
        {
          ...
          "markdown": {
            "en-GB": "No GP referral needed to receive treatment for certain conditions — listed above.",
        ...
        },
        {
          ...
          "markdown": {
            "en-GB": "Direct Access: 0345 600 8277\n\nDo note: Your Bupa Membership Details will be required — find them in your Bupa Touch account.",
            "ja-JP": "直接アクセス0345 600 8277\n\nご注意：Bupa会員の詳細が必要です。Bupa Touchアカウントでご確認ください。"
          },
          "_id": generateRandomMongoId(),
          "type": "MARKDOWN"
        },
