...
export const SMOKING_CELEBRATION_DAYS = `SMOKING_CELEBRATION_DAYS`;
export const SMOKING_CELEBRATION_YUCOIN = `SMOKING_CELEBRATION_YUCOIN`;
export const SMOKING_CELEBRATION_IMAGE_CONTAINER = `SMOKING_CELEBRATION_IMAGE_CONTAINER`;
export const SMOKING_CELEBRATION_CUSTOM_IMAGE = `SMOKING_CELEBRATION_CUSTOM_IMAGE`;
