...
export const ACTIVITY_HISTORY_CHALLENGE_VALUE = (title: string) => `ACTIVITY_HISTORY_CHALLENGE_VALUE_${title}`
...
export const YUSCREEN_V5_WELLBEING_SECTION_BUTTON_TEXT_VIEW = "YUSCREEN_V5_WELLBEING_SECTION_BUTTON-text-view"
...
export const CLAIMED_SMOKING_CAROUSEL_LIST_ITEM = (id:string) => `CLAIMED_SMOKING_CAROUSEL_LIST_ITEM_${id}`
