...
export const REWARDS_UNLOCK_SCROLL = "REWARDS_UNLOCK_SCROLL";
export const SHOPFRONT_REWARDS_LIST = "SHOPFRONT_REWARDS_LIST";
...
export const REFERRALS_SCREEN_NAME = (name: string) => `REFERRALS_SCREEN_NAME_${name}`;
export const LEADERBOARD_USER_REFERRAL = "LEADERBOARD_USER_REFERRAL";
...
export const STREAK_TICKS = (label: string, isChecked: boolean) =>
  `STREAK_TICKS_${label}_${isChecked}`;
...
export const REFERRALS_BUSINESS_ACCOUNT_DROP_DOWN = "REFERRALS_BUSINESS_ACCOUNT_DROP_DOWN";
export const REFERRALS_BUSINESS_ACCOUNT_NAME = (title: string) =>
  `REFERRALS_BUSINESS_ACCOUNT_NAME_${title}`;
export const REFERRALS_SHARE_CODE_BUTTON = `REFERRALS_SHARE_CODE_BUTTON`;
export const REFERRALS_CODE_TITLE = (title: string) => `REFERRALS_CODE_TITLE_${title}`;
export const REFERRALS_CODE = (code: string) => `REFERRALS_CODE_${code}`;
...
export const AV_PLAYER_TIMER = (time: string) => `AV_PLAYER_TIMER_${time}`;
...
export const SMOKING_HUB_CTA = "SMOKING_HUB_CTA";
...
export const SMOKING_CELEBRATION_TITLE = `SMOKING_CELEBRATION_TITLE`;
export const SMOKING_CELEBRATION_DAYS = (days: string) => `SMOKING_CELEBRATION_DAYS_${days}`;
export const SMOKING_CELEBRATION_YUCOIN = (yucoin: number) =>
  `SMOKING_CELEBRATION_YUCOIN_${yucoin}`;
export const SMOKING_CELEBRATION_IMAGE_CONTAINER = `SMOKING_CELEBRATION_IMAGE_CONTAINER`;
export const SMOKING_CELEBRATION_CUSTOM_IMAGE = (id: string) =>
  `SMOKING_CELEBRATION_CUSTOM_IMAGE_${id}`;
export const SMOKING_CELEBRATION_DESCRIPTION = `SMOKING_CELEBRATION_DESCRIPTION`;
...
export const CLAIMED_BATTLE_PASS_LIST_ITEM = (position: number) =>
  `CLAIMED_BATTLE_PASS_LIST_ITEM_${position}`;
...
export const BATTLE_PASS_INTRO_SCREEN = "BATTLE_PASS_INTRO_SCREEN";
export const BATTLE_PASS_INTRO_SCREEN_TITLE = (title: string) =>
  `BATTLE_PASS_INTRO_SCREEN_TITLE_${title}`;
export const BATTLE_PASS_INTRO_SCREEN_CTA_BUTTON = "BATTLE_PASS_INTRO_SCREEN_CTA_BUTTON";
export const BATTLE_PASS_INTRO_STEP = (stepNumber: number) =>
  `BATTLE_PASS_INTRO_STEP_${stepNumber}`;
export const BATTLE_PASS_FIRST_LEVEL_SCREEN = "BATTLE_PASS_FIRST_LEVEL_SCREEN";
export const BATTLE_PASS_FIRST_LEVEL_TITLE = (title: string) =>
  `BATTLE_PASS_FIRST_LEVEL_TITLE_${title}`;
export const BATTLE_PASS_FIRST_LEVEL_DONATION_CARD = (id: string) =>
  `BATTLE_PASS_FIRST_LEVEL_DONATION_CARD_${id}`;
export const BATTLE_PASS_FIRST_LEVEL_DONATION_CARD_INFO_BUTTON = (id: string) =>
  `BATTLE_PASS_FIRST_LEVEL_DONATION_CARD_INFO_BUTTON_${id}`;
export const BATTLE_PASS_FIRST_LEVEL_DONATION_CARD_TITLE = (title: string) =>
  `BATTLE_PASS_FIRST_LEVEL_DONATION_CARD_TITLE_${title}`;
...
export const PATHWAY_GOALS_PICKER_SCREEN = "PATHWAY_GOALS_PICKER_SCREEN";
export const PATHWAY_GOALS_PICKER_BACK = "PATHWAY_GOALS_PICKER_BACK";
export const PATHWAY_GOALS_PICKER_CARD = (id: string) => `PATHWAY_GOALS_PICKER_CARD_${id}`;
export const PATHWAY_GOALS_PICKER_ACCEPT = "PATHWAY_GOALS_PICKER_ACCEPT";
export const PATHWAY_GOALS_PICKER_SKIP = "PATHWAY_GOALS_PICKER_SKIP";
export const PATHWAY_GOALS_PICKER_RECAP = "PATHWAY_GOALS_PICKER_RECAP";
export const PATHWAY_GOALS_PICKER_RECAP_ROW = (id: string) =>
  `PATHWAY_GOALS_PICKER_RECAP_ROW_${id}`;
export const PATHWAY_GOALS_PICKER_CONFIRM = "PATHWAY_GOALS_PICKER_CONFIRM";
export const PATHWAY_GOALS_PICKER_CONTINUE = "PATHWAY_GOALS_PICKER_CONTINUE";
