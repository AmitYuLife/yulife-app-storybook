...
export const CRUR_20_BUPA = {
  type: "mongo",
  modelName: "core_reward_user_restriction",
  data: {
    _id: generateRandomMongoId(),
    userId: users.USER_144.data.userId,
    rewardId: rewards.CORE_REWARDS_BUPA_GIP_REWARDS.data._id,
    state: "tease",
    source: "goal_products",
    createdAt: moment(),
...
export const CRUR_20_MEDITOPIA = {
  type: "mongo",
  modelName: "core_reward_user_restriction",
  data: {
    _id: generateRandomMongoId(),
...
export const CRUR_20_BETTERHELP = {
  type: "mongo",
  modelName: "core_reward_user_restriction",
  data: {
    _id: generateRandomMongoId(),
...
export const CRUR_20_SKINVISION = {
  type: "mongo",
  modelName: "core_reward_user_restriction",
  data: {
    _id: generateRandomMongoId(),
...
export const CRUR_20_SLEEPCYCLE = {
  type: "mongo",
  modelName: "core_reward_user_restriction",
  data: {
    _id: generateRandomMongoId(),
