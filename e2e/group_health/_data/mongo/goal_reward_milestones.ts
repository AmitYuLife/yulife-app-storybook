...
export const GOAL_REWARD_MILESTONE_29_GIP_REWARDS = {
  ...
  data: {
    ...
    teaser: {
      ...
      description: {
        "en-GB":
          '"- Get a comprehensive picture of your current health and future risks. - Assessments include various tests, such as blood tests, cholesterol checks, and lifestyle evaluations, tailored to your needs."',
        _id: generateRandomMongoId(),
        "ja-JP":
          '「現在の健康状態と将来のリスクを総合的に把握する。- アセスメントには、血液検査、コレステロールチェック、生活習慣の評価など、あなたのニーズに合わせた様々な検査が含まれます。"',
      },
      image: "",
      _id: generateRandomMongoId(),
    },
    ...
    explanations: [
      ...
      },
      {
        label: {
          ...
          _id: generateRandomMongoId(),
          "ja-JP":
            "アセスメントには、血液検査、コレステロールチェック、生活習慣の評価など、患者のニーズに合わせたさまざまな検査が含まれる。",
        },
      },
    ],
  },
    ...
    explanations: [
      ...
      },
      {
        label: {
          ...
          _id: generateRandomMongoId(),
          "ja-JP":
            "ガイド付き瞑想、睡眠体験談、マインドフルネスの実践など、さまざまなものを手に入れよう。",
        },
      },
    ],
  },
    ...
    explanations: [
      {
        label: {
          ...
          _id: generateRandomMongoId(),
          "ja-JP":
            "ご自宅にいながら、ストレス、不安、人間関係、その他の葛藤をセラピーでコントロールしましょう。",
        },
      },
      {
        label: {
    ...
    explanations: [
      ...
      },
      {
        label: {
          ...
          _id: generateRandomMongoId(),
          "ja-JP":
            "あなたの携帯電話のカメラでほくろや皮膚の斑点をスキャンし、即座にリスク評価を受けることができます。",
        },
      },
    ],
  },
    ...
    explanations: [
      {
        label: {
          ...
          _id: generateRandomMongoId(),
          "ja-JP":
            "睡眠の質を高め、すっきりとした目覚めをサポートするスマートな目覚まし時計アプリ。",
        },
      },
      {
        label: {
          ...
          _id: generateRandomMongoId(),
          "ja-JP":
            "睡眠統計、サウンドスケープ、パーソナライズされたインサイトなどの機能をお楽しみください。",
        },
      },
    ],
  },
...
export const GOAL_REWARD_MILESTONE_35_GIP_REWARDS = {
  ...
  data: {
    ...
    rewardQuantity: 1,
    earnRateBased: true,
    rewardId: "66fc179e051e9482213508a6",
    rewardTitle: {
    ...
    explanations: [
      ...
      },
      {
        label: {
          ...
          _id: generateRandomMongoId(),
          "ja-JP":
            "Withings Health Mateアプリで、あなたの携帯電話にパーソナライズされたインサイトと進捗状況のトラッキングを。",
        },
      },
    ],
  },
    ...
    explanations: [
      ...
      },
      {
        label: {
          ...
          _id: generateRandomMongoId(),
          "ja-JP":
            "このアプリは、瞬時に正確な結果を提供し、あなたの健康データに基づいてパーソナライズされたアドバイスを提供する。",
        },
      },
    ],
  },
    ...
    explanations: [
      {
        label: {
          ...
          _id: generateRandomMongoId(),
          "ja-JP":
            "食事量、運動量、生活習慣全般を記録して、フィットネスと栄養の目標を達成しましょう。",
        },
      },
      {
        label: {
          ...
          _id: generateRandomMongoId(),
          "ja-JP":
            "食事プランをパーソナライズし、カロリーを記録し、特定のニーズに合わせた栄養アドバイスを受けることができます。",
        },
      },
    ],
  },
    ...
    explanations: [
      {
        label: {
          ...
          _id: generateRandomMongoId(),
          "ja-JP":
            "パーソナライズされたトレーニングプラン、進捗管理、コミュニティチャレンジでフィットネスゴールを達成しましょう。",
        },
      },
      {
        label: {
          ...
          _id: generateRandomMongoId(),
          "ja-JP":
            "筋力トレーニング、ヨガ、HIIT、ピラティスなどのオンデマンドクラスを無制限に利用できる。",
        },
      },
    ],
  },
    ...
    explanations: [
      ...
      },
      {
        label: {
          ...
          _id: generateRandomMongoId(),
          "ja-JP":
            "熱心なランナーでも、走り始めたばかりのランナーでも、ニューバランス880はあなたのランニングの旅に最適だ。",
        },
      },
    ],
  },
...
export const GOAL_REWARD_MILESTONE_40_GIP_REWARDS = {
  type,
  modelName,
  data: {
    _id: generateRandomMongoId(),
...
export const GOAL_REWARD_MILESTONE_41_GIP_REWARDS = {
  type,
  modelName,
  data: {
    _id: generateRandomMongoId(),
...
export const GOAL_REWARD_MILESTONE_42_GIP_REWARDS = {
  type,
  modelName,
  data: {
    _id: generateRandomMongoId(),
...
export const GOAL_REWARD_MILESTONE_43_GIP_REWARDS = {
  type,
  modelName,
  data: {
    _id: generateRandomMongoId(),
...
export const GOAL_REWARD_MILESTONE_44_GIP_REWARDS = {
  type,
  modelName,
  data: {
    _id: generateRandomMongoId(),
...
export const GOAL_REWARD_MILESTONE_45_GIP_REWARDS = {
  type,
  modelName,
  data: {
    _id: generateRandomMongoId(),
...
export const GOAL_REWARD_MILESTONE_46_GIP_REWARDS = {
  type,
  modelName,
  data: {
    _id: generateRandomMongoId(),
...
export const GOAL_REWARD_MILESTONE_47_GIP_REWARDS = {
  type,
  modelName,
  data: {
    _id: generateRandomMongoId(),
...
export const GOAL_REWARD_MILESTONE_48_GIP_REWARDS = {
  type,
  modelName,
  data: {
    _id: generateRandomMongoId(),
...
export const GOAL_REWARD_MILESTONE_49_GIP_REWARDS = {
  type,
  modelName,
  data: {
    _id: generateRandomMongoId(),
...
export const GOAL_REWARD_MILESTONE_50_GIP_REWARDS = {
  type,
  modelName,
  data: {
    _id: generateRandomMongoId(),
