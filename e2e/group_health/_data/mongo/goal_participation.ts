...
export const GOAL_PARTICIPATION_21 = {
  ...
  data: {
    ...
    typesToTrack: ["user_levelled_up"],
    autoClaimRewards: true,
    customerProductId: cpe.CPE_141_GIP_REWARDS.data.customer_product_id,
...
export const GOAL_PARTICIPATION_22_GHI_REWARDS = {
  type: "mongo",
  modelName: "goal_participation",
  data: {
    _id: generateRandomMongoId(),
    ...
    typesToTrack: ["user_levelled_up"],
    autoClaimRewards: true,
    customerProductId: cpe.CPE_141_GHI_REWARDS.data.customer_product_id,
    customerProductIds: [cpe.CPE_141_GHI_REWARDS.data.customer_product_id],
    userId: customers.CUSTOMER_141.data.customerId,
    goal: GOAL_PRODUCTS_1.data._id,
    parentType: "goal_products",
    team: gt.GOAL_TEAM_22B.data._id,
    iterationId: "1",
    startDateTime: moment().subtract(1, "d").format("YYYY-MM-DD"),
    joinGoalTime: moment().subtract(1, "d").format("YYYY-MM-DD"),
    endDateTime: moment().add(7, "days").format("YYYY-MM-DD"),
...
export const GOAL_PARTICIPATION_25 = {
  type: "mongo",
  modelName: "goal_participation",
  data: {
    _id: generateRandomMongoId(),
    ...
    typesToTrack: ["user_levelled_up"],
    autoClaimRewards: true,
    customerProductId: cpe.CPE_144_GIP_REWARDS.data.customer_product_id,
    customerProductIds: [cpe.CPE_144_GIP_REWARDS.data.customer_product_id],
    userId: customers.CUSTOMER_144.data.customerId,
    goal: GOAL_PRODUCTS_5.data._id,
    parentType: "goal_products",
    team: gt.GOAL_TEAM_25.data._id,
    iterationId: "1",
    startDateTime: moment().subtract(1, "d").format("YYYY-MM-DD"),
    joinGoalTime: moment().subtract(1, "d").format("YYYY-MM-DD"),
    endDateTime: moment().add(7, "days").format("YYYY-MM-DD"),
