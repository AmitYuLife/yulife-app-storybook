...
export const CORE_REWARDS_AMAZON = {
  ...
  data: {
    ...
    images: {
      ...
      detailHeaderKey:
        "https://gift-sandbox.wegift.io/static/product_assets/AMAZON/AMAZON-card.png",
    },
    loyaltyProgramme: [],
    sortOrder: 18,
    rewardProviderId: "wegift",
    ...
    redemptionSteps: {
      steps: [
        ...
        },
        {
          ...
          "es-ES":
            "Comprueba tu correo electrónico, ¡te hemos enviado algo! (Es el código del vale).",
        ...
        },
        {
          ...
          "ja-JP":
            "Bupa Clinicsの電話番号0370 218 4965に電話して、対面式健康診断を予約してください。",
        },
        {
          "en-GB":
        ...
        },
        {
          ...
          "es-ES":
            "Disfrute de su chequeo médico gratuito en persona. (Y, una vida saludable por delante).",
      ...
      steps: [
        {
          ...
          "ja-JP":
            "ガーミン・スマートウォッチまたはGOSHの寄付のいずれかを選択し、報酬を請求してください！",
        },
        {
...
export const CORE_REWARDS_THRIVA_GHI_REWARDS = {
  ...
  data: {
    ...
    currencyCode: "GBP",
    termsAndConditionsUrl:
      "https://s3-eu-west-1.amazonaws.com/thriva/legal/Customer+Terms+and+Conditions.pdf",
    redemptionSteps: {
      steps: [
        {
          "en-GB": "Claim your reward!",
        ...
        },
        {
          ...
          "es-ES":
            "Comprueba tu correo electrónico, te hemos enviado un enlace al sitio web de Thriva.",
...
export const CORE_REWARDS_BUPA_GIP_REWARDS = {
  ...
  data: {
    ...
    loyaltyProgramme: [],
    redemptionUrl:
      "https://www.bupa.co.uk/health/health-assessments/compare-health-assessments-yulife",
    currencyCode: "GBP",
    images: {
    ...
    redemptionSteps: {
      ...
      steps: [
        ...
        {
          "en-GB":
            "You will land on a Bupa-YuLife page where you can browse a range of health assessments.",
          _id: generateRandomMongoId(),
          "ja-JP": "2.Bupa-YuLifeのページに移動し、様々な健康評価を閲覧することができます。",
        },
        {
          "en-GB":
            "Once you have selected your assessment, copy the discount code associated with your test.",
          _id: generateRandomMongoId(),
        ...
        },
        {
          ...
          _id: generateRandomMongoId(),
          "ja-JP":
            "5.お電話でのご予約：ブッパ・ユーライフのページに記載されている電話番号をご利用ください。",
        },
        {
          "en-GB":
            "Confirm with Bupa that you are a YuLife member and that you want to self-pay for a health assessment.",
          _id: generateRandomMongoId(),
          "ja-JP":
            "6.Bupaに、あなたがYuLife会員であり、健康診断の自己負担を希望していることを確認します。",
        },
        {
          "en-GB":
            "Bupa will help you setup your account, discuss the product range with you, and help you set up an appointment.",
          _id: generateRandomMongoId(),
          "ja-JP":
            "7.Bupaは、あなたのアカウントを設定し、製品の範囲についてあなたと議論し、あなたが予約を設定するのに役立ちます。",
        },
        {
          "en-GB":
            "You payment details will be taken but payment will only be made the day of the appointment.",
          _id: generateRandomMongoId(),
        ...
        {
          "en-GB":
            "To make a booking via email: tap the 'Email us' button. Fill in your contact information on the landing page.",
          _id: generateRandomMongoId(),
          "ja-JP":
            "10.Eメールで予約する場合：「Eメールする」ボタンをタップします。ランディングページで連絡先情報を入力します。",
        },
        {
    ...
    termsAndConditionsUrl:
      "https://www.bupa.co.uk/health/health-assessments/ha-frequently-asked-questions",
    restrictions: {
      availableForLabels: ["670fd48d23f0dacc22e2ecf0_tease", "670fd48d23f0dacc22e2ecf0_claimable"],
      restrictedForLabels: [],
      locations: ["GB"],
    },
    tags: [
  ...
  data: {
    ...
    redemptionSteps: {
      ...
      steps: [
        ...
        {
          "en-GB":
            "Select your desired scan and a location, proce, and appointment that suits you.",
          _id: generateRandomMongoId(),
        ...
        },
        {
          ...
          _id: generateRandomMongoId(),
          "ja-JP":
            "安全に関する質問にお答えいただき、お支払いをお済ませいただくと、チェックアウト時に自動的に最大15％のYuLife割引が適用されます。",
        },
        {
          "en-GB":
            "Within 2 days you'll receive a phone consultation with an expert clinician who will ask about your symptoms and complete your referral.",
          _id: generateRandomMongoId(),
          "ja-JP":
            "安全に関する質問にお答えいただき、お支払いをお済ませいただくと、チェックアウト時に自動的に最大15％のYuLife割引が適用されます。",
        },
        {
          "en-GB":
            "After referral, your chosen scanning site will call you to offer a choice of appointment times. Please note that some sites will allow you to pre-select the time of your scan at the point of booking.",
          _id: generateRandomMongoId(),
          "ja-JP":
            "紹介後、選択されたスキャン施設から電話連絡があり、予約時間の選択ができます。サイトによっては、予約時にスキャン時間を事前に選択できるところもありますので、ご注意ください。",
        },
        {
        ...
        {
          "en-GB":
            "After your scan you will receive your results via email. You can also request copies of your images if needed for onward care. If any abnormalities are found you will be contacted by a clinician to discuss the next steps.",
          _id: generateRandomMongoId(),
          "ja-JP":
            "スキャン後、Eメールで結果が届きます。その後のケアに必要であれば、画像のコピーを請求することもできます。異常が見つかった場合は、次のステップについて医師からご連絡いたします。",
        },
      ],
    },
  ...
  data: {
    ...
    copy: {
      ...
      alertSubheading: {
        ...
        _id: generateRandomMongoId(),
        "ja-JP":
          "確認する」をタップして、12ヶ月の無料プレミアムメディトピア購読をお申し込みください。",
      },
      offerHeading: {
    ...
    redemptionSteps: {
      ...
      steps: [
        ...
        {
          "en-GB":
            "Download the Meditopia app, sign in, and enjoy your 12-month premium subscription!",
          _id: generateRandomMongoId(),
...
export const CORE_REWARDS_BETTERHELP_GIP_REWARDS = {
  ...
  data: {
    ...
    loyaltyProgramme: [],
    redemptionUrl:
      "https://hasofferstracking.betterhelp.com/aff_c?offer_id=40&aff_id=4268&source=yulife15",
    currencyCode: "GBP",
    images: {
    ...
    redemptionSteps: {
      ...
      steps: [
        ...
        {
          "en-GB":
            "Complete your preference questions and create an account on the BetterHelp page you're taken to.",
          _id: generateRandomMongoId(),
    ...
    restrictions: {
      availableForLabels: ["670fdd6523f0dacc22e2ef2c_tease", "670fdd6523f0dacc22e2ef2c_claimable"],
      restrictedForLabels: [],
      locations: [],
    },
    tags: [
...
export const CORE_REWARDS_SKINVISION_GIP_REWARDS = {
  ...
  data: {
    ...
    termsAndConditionsUrl:
      "https://skinvision-static-content.s3-eu-west-1.amazonaws.com/website/en/Terms_and_Conditions.pdf",
    restrictions: {
      availableForLabels: ["670fde2923f0dacc22e2ef4d_tease", "670fde2923f0dacc22e2ef4d_claimable"],
      restrictedForLabels: [],
      locations: [],
    },
    tags: [
  ...
  data: {
    ...
    redemptionSteps: {
      ...
      steps: [
        ...
        {
          "en-GB":
            "Download the Sleep Cycle app, sign in, and enjoy your 12-month premium subscription!",
          _id: generateRandomMongoId(),
          "ja-JP":
            "Sleep Cycleアプリをダウンロードしてサインインし、12ヶ月のプレミアム購読をお楽しみください！",
        },
      ],
    },
    termsAndConditionsUrl:
      "https://support.sleepcycle.com/hc/en-us/articles/115002692205-Sleep-Cycle-Premium-Terms-Conditions-",
    restrictions: {
      availableForLabels: ["670fd99423f0dacc22e2ee32_tease", "670fd99423f0dacc22e2ee32_claimable"],
      restrictedForLabels: [],
      locations: [],
    },
    tags: [
...
export const CORE_REWARDS_POCDOC_GIP_REWARDS = {
  ...
  data: {
    ...
    termsAndConditionsUrl: "https://",
    restrictions: {
      availableForLabels: ["670fe1f923f0dacc22e2f032_tease", "670fe1f923f0dacc22e2f032_claimable"],
      restrictedForLabels: [],
      locations: [],
    },
    tags: [
  ...
  data: {
    ...
    redemptionSteps: {
      ...
      steps: [
        ...
        {
          "en-GB":
            "Download the Lifesum app, sign in, and enjoy your 12-month premium subscription!",
          _id: generateRandomMongoId(),
          "ja-JP": "アカウントをお持ちでない場合は作成してください。",
        },
      ],
    ...
    restrictions: {
      availableForLabels: ["670fdbf123f0dacc22e2eedb_tease", "670fdbf123f0dacc22e2eedb_claimable"],
      restrictedForLabels: [],
      locations: ["GB"],
    },
    tags: [
    ...
    redemptionSteps: {
      ...
      steps: [
        ...
        },
        {
          ...
          _id: generateRandomMongoId(),
          "ja-JP":
            "Fiitアプリをダウンロードしてサインインし、12ヶ月のプレミアム購読をお楽しみください！",
        },
      ],
    },
    termsAndConditionsUrl: "https://",
    restrictions: {
      availableForLabels: ["670fd8fc23f0dacc22e2edf7_tease", "670fd8fc23f0dacc22e2edf7_claimable"],
      restrictedForLabels: [],
      locations: [],
    },
    tags: [
...
export const CORE_REWARDS_NIKE_GIP_REWARDS = {
  ...
  data: {
    ...
    termsAndConditionsUrl: "https://",
    restrictions: {
      availableForLabels: ["670fe2f323f0dacc22e2f05a_tease", "670fe2f323f0dacc22e2f05a_claimable"],
      restrictedForLabels: [],
      locations: [],
    },
    tags: [
