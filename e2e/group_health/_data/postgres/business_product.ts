...
export const BUSINESS_PRODUCT_13_GHI_REWARDS = generateProductRecords({
    ...
    product: {
        policy_start_date: moment().subtract(2, "days").format("YYYY-MM-DD"),
        eventStartDate: moment().subtract(2, "days").format("YYYY-MM-DD"),
        productGoalTag: GOAL_PRODUCTS_1.data.tag,
    },
    quote: {
        ...
        base_earn_rate: 2,
        max_win_win_rebate: 0.0,
        quote_issued_date: moment().subtract(2, "days").format("YYYY-MM-DD"),
        sales_person: "dfefsdf",
        provisional_payment_frequency: "M",
        provisional_data_upload_frequency: "A",
        deal_type: null,
    ...
    schedule: {
        ...
        external_schedule_id: null,
        pension_scheme_tax_ref: null,
        effective_date: moment().subtract(2, "days").format("YYYY-MM-DD"),
        automatic_acceptance_limit: null,
        policy_tcs_ref: null,
        created_by_id: null,
        created_at: moment().subtract(2, "days").format("YYYY-MM-DD"),
    ...
    period: {
        number_of_lives: 99,
        period_start_date: moment().subtract(2, "days").format("YYYY-MM-DD"),
    ...
    commissionTerm: {
        ...
        yulife_commission: 0.02,
        negotiated_additional_commission: 0.0,
        true_up_date: "2026-04-17",
        effective_from: moment().subtract(2, "days").format("YYYY-MM-DD"),
        modified_by_id: null,
        created_by_id: null,
        modified_at: "2023-04-17T16:40:03.214Z",
