...
export const CBP_142_GIP_REWARDS = {
  type,
  modelName,
  data: {
    business_product_id: BUSINESS_PRODUCT_18_METLIFE_GIP.product.data.product_id,
    customer_product_id: cpe.CPE_142_GIP_REWARDS.data.customer_product_id,
    category_id: "1",
    start_date: moment().subtract(8, "months").format("YYYY-MM-DD"),
    archived: false,
    data: '{"salary":10000,"workplacePostcode":"NW1 1LX","country":"GB","jobTitle":"Software Engineer","dateOfBirth":"2000-01-21","firstName":"Sarah","lastName":"Smith","sexAtBirth":"F","addressLineOne":"57 Market St","addressLineTwo":"Huddersfield","addressPostCode":"HD3 4HX","title":"Mrs", "externalMembershipNumber":"12121212"}',
...
export const CBP_143_GIP_REWARDS = {
  type,
  modelName,
  data: {
    business_product_id: BUSINESS_PRODUCT_18_METLIFE_GIP.product.data.product_id,
    customer_product_id: cpe.CPE_143_GIP_REWARDS.data.customer_product_id,
    category_id: "1",
    start_date: moment().subtract(8, "months").format("YYYY-MM-DD"),
    archived: false,
    data: '{"salary":10000,"workplacePostcode":"NW1 1LX","country":"GB","jobTitle":"Software Engineer","dateOfBirth":"2000-01-21","firstName":"Sarah","lastName":"Smith","sexAtBirth":"F","addressLineOne":"57 Market St","addressLineTwo":"Huddersfield","addressPostCode":"HD3 4HX","title":"Mrs", "externalMembershipNumber":"12121212"}',
...
export const CBP_144_GIP_REWARDS = {
  type,
  modelName,
  data: {
    business_product_id: BUSINESS_PRODUCT_18_METLIFE_GIP.product.data.product_id,
    customer_product_id: cpe.CPE_144_GIP_REWARDS.data.customer_product_id,
    category_id: "1",
    start_date: moment().subtract(8, "months").format("YYYY-MM-DD"),
    archived: false,
    data: '{"salary":10000,"workplacePostcode":"NW1 1LX","country":"GB","jobTitle":"Software Engineer","dateOfBirth":"2000-01-21","firstName":"Sarah","lastName":"Smith","sexAtBirth":"F","addressLineOne":"57 Market St","addressLineTwo":"Huddersfield","addressPostCode":"HD3 4HX","title":"Mrs", "externalMembershipNumber":"12121212"}',
