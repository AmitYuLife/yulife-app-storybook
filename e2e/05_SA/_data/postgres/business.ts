...
import { BUSINESS_BACKGROUND_SA_1 } from "./business_background";

const type = "postgres"
const modelName = "business"

export const BUSINESS_ACCOUNT_SA_1 = {
    type: "postgres",
    modelName: "business",
    data: {
        business_background_id: BUSINESS_BACKGROUND_SA_1.data.business_background_id,
        business_account_id: generateRandomTransformedUuid(),
        business_account_name: 'YU LIFE SA LTD',
        coupon: null,
        status: null,
