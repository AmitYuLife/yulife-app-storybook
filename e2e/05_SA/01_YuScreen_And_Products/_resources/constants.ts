...
export const gciDisclaimer = "Note that payments for some conditions are tiered based on the severity of the condition. A less severe condition can result in a lower payout - e.g. 25% or 50% of the total cover amount stipulated. Refer to your Membership Certificate or Policy Guide for a detailed list of conditions, levels, and payouts."
...
export const gciDescription = "Pays a lump sum if you suffer one of the defined medical conditions."
export const gciKeyInfoText = "If you have a condition that existed within 12 months of the policy inception you will not be covered for a repeat of the condition for the next 24 months."
...
export const yellowProductSlotBackground = "https://yulife-develop.imgix.net/yuscreen/slots/background/bg-gold-18-07-22.svg?ixlib=js-3.2.1&w=135&h=162&s=4d4883a6124eb597b6a3e8c44ee21c71"
...
export const magnifyingGlassTopRightImg = "https://yulife-develop.imgix.net/yuscreen_products_assets/default/magnifier_active.svg?ixlib=js-3.2.1&w=180&h=180&s=42c312245e546023876a8a475960196a"