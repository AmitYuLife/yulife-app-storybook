...
export const CBP_USA_1_MOO = {
  type,
  modelName,
  data: {
    business_product_id: bp.BUSINESS_PRODUCT_USA_1_MOO.product.data.product_id,
    customer_product_id: cpe.CPE_MOO_USA_1.data.customer_product_id,
    category_id: 1,
    start_date: cpe.CPE_Wellbeing_USA_1.data.start_date,
    data: {
      date_of_birth: cpe.CPE_Wellbeing_USA_1.data.date_of_birth,
