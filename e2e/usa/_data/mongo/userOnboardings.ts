...
export const USER_ONBOARDING_USA_12  = {
    type,
    modelName,
    data:{
        _id:generateRandomMongoId(),
        userId: user.USER_USA_12.data.userId,
        signupComplete: false,
        firstAppOpen: false,
        companyLeaderboardAccepted: true,
        companyLeaderboardCurrentConsent: false,
...
export const USER_ONBOARDING_USA_13  = {
    type,
    modelName,
    data:{
        _id:generateRandomMongoId(),
        userId: user.USER_USA_13.data.userId,
        signupComplete: false,
        firstAppOpen: false,
        companyLeaderboardAccepted: true,
        companyLeaderboardCurrentConsent: false,
...
export const USER_ONBOARDING_USA_14  = {
    type,
    modelName,
    data:{
        _id:generateRandomMongoId(),
        userId: user.USER_USA_14.data.userId,
        signupComplete: false,
        firstAppOpen: false,
        companyLeaderboardAccepted: true,
        companyLeaderboardCurrentConsent: false,
...
export const USER_ONBOARDING_USA_15  = {
    type,
    modelName,
    data:{
        _id:generateRandomMongoId(),
        userId: user.USER_USA_15.data.userId,
        signupComplete: false,
        firstAppOpen: false,
        companyLeaderboardAccepted: true,
        companyLeaderboardCurrentConsent: false,
