...
export const CBP_1_GMI = {
  type,
  modelName,
  data: {
    business_product_id: bp.BUSINESS_PRODUCT_1_GMI.product.data.product_id,
    customer_product_id: cpe.CPE_GMI_1.data.customer_product_id,
    category_id: 1,
    start_date: moment().subtract(6, "months").format("YYYY-MM-DD"),
    archived: false,
    data: {
...
export const CBP_2_DBI = {
  ...
  data: {
    business_product_id: bp.BUSINESS_PRODUCT_1_DBI.product.data.product_id,
    customer_product_id: cpe.CPE_DBI_2.data.customer_product_id,
    category_id: 1,
    start_date: moment().subtract(6, "months").format("YYYY-MM-DD"),
    archived: false,
    data: {
...
export const CBP_2_GMI = {
  type,
  modelName,
  data: {
    business_product_id: bp.BUSINESS_PRODUCT_1_GMI.product.data.product_id,
    customer_product_id: cpe.CPE_GMI_2.data.customer_product_id,
    category_id: 1,
    start_date: moment().subtract(6, "months").format("YYYY-MM-DD"),
    archived: false,
    data: {
...
export const CBP_2_TDI = {
  type,
  modelName,
  data: {
    business_product_id: bp.BUSINESS_PRODUCT_1_TDI.product.data.product_id,
    customer_product_id: cpe.CPE_TDI_2.data.customer_product_id,
    category_id: 1,
    start_date: moment().subtract(6, "months").format("YYYY-MM-DD"),
    archived: false,
    data: {
