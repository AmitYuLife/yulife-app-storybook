import { CHALLENGE_REWARD, CHALLENGE_SUCCESS_SCREEN, DAILY_STEPS_SCREEN, FIIT_CATEGORY_LIST_DESCRIPTION, FIIT_CATEGORY_LIST_HEADER, FIIT_CATEGORY_LIST_SCREEN, FIIT_MEDIA_ITEM_DESCRIPTION, FIIT_MEDIA_SCROLL_VIEW, FITT_MEDIA_ITEM_TITLE, MEDIA_STAR_REWARD, MEDIA_YUCOIN_REWARD, navigation, VIDEO_PLAYER_DESCRIPTION_SCREEN, VIDEO_PLAY_PAUSE_BUTTON, VIEW_TOP_RIGHT_COIN_COUNTER } from "@utils";
