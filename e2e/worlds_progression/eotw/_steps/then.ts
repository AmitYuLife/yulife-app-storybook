...
export const challengeSelectedModalVisible =
  (amount: string, challengeAmount: string) => async () => {
...
export const challengeProgressShown =
  (progress: number, max: number, color: string) => async () => {
...
export const nextYuniversalStageLocked = (level: string) => async () => {
