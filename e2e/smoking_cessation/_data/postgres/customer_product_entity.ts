...
import {
  BUSINESS_EMPLOYEE_BENDER,
  BUSINESS_EMPLOYEE_FRY,
  BUSINESS_EMPLOYEE_LEELA,
  BUSINESS_EMPLOYEE_ZAPP,
  BUSINESS_EMPLOYEE_ZOIDBERG,
  BUSINESS_EMPLOYEE_AMY,
  BUSINESS_EMPLOYEE_HERMES,
  BUSINESS_EMPLOYEE_KIF,
  BUSINESS_EMPLOYEE_CALCULON,
...
export const CPE_CALCULON_RGL = {
  type,
  modelName,
  data: {
    customer_product_id: "YUCPID00000000009",
    customer_id: customer.CUSTOMER_CALCULON.data.customerId,
    earn_rate: 10,
    start_date: moment().subtract(6, "months").toDate(),
    underwriting_step: null,
    is_banned_from_product: false,
    taken_up: true,
    product_variant_id: "AIG_ReGL_01_01",
    business_employee_id: BUSINESS_EMPLOYEE_CALCULON.data.business_employee_id,
  },
} as IDatabaseItem;
