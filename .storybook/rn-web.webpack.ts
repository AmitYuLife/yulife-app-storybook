...
export const RN_WEB_ALIASES: Record<string, string> = {
  ...
  "@yulife-private/design-system": path.resolve(__dirname, "../packages/yulife-design-system/src"),
  "@storybook/interaction-states": path.resolve(__dirname, "./interaction-states.tsx"),
  ...
  "@navigation/root": path.join(__dirname, "/aliases/navigation-root.js"),
  "@navigation/routes": path.join(__dirname, "/aliases/navigation-routes.js"),
  [path.resolve(__dirname, "../src/navigation/root")]: path.resolve(__dirname, "./aliases/navigation-root.js"),
  [path.resolve(__dirname, "../src/navigation/root.ts")]: path.resolve(__dirname, "./aliases/navigation-root.js"),
  [path.resolve(__dirname, "../src/navigation/routes")]: path.resolve(__dirname, "./aliases/navigation-routes.js"),
  [path.resolve(__dirname, "../src/navigation/routes.ts")]: path.resolve(__dirname, "./aliases/navigation-routes.js"),
  ...
  [path.resolve(__dirname, "../src/services/socket/socketClient")]: path.join(__dirname, "/aliases/socket-client.js"),
  [path.resolve(__dirname, "../src/services/socket/socketClient.ts")]: path.join(
    __dirname,
    "/aliases/socket-client.js"
  ),
  ...
  config.module.rules = [
    ...
    },
    {
      ...
      include: [
        ...
        path.resolve(__dirname, "../packages/yulife-design-system/src"),
        path.resolve(__dirname, "../e2e/_utils/navigation"),
